<div class="stack">
  ...
  <?php foreach ($habits as $habit): ?>
    <div class="stack panel">
      <div class="row" style="justify-content: space-between;">
        ...
        <div class="row">
          <form method="post" action="/habitos/activar">
          ...
          <a class="btn" href="/habitos/editar?id=<?php echo e($habit['id']); ?>">editar</a>
          <form method="post" action="/habitos/borrar">
            <input type="hidden" name="csrf_token" value="<?php echo e(csrf_token()); ?>">
            <input type="hidden" name="id" value="<?php echo e($habit['id']); ?>">
  ...
  <a class="btn" href="/habitos/nuevo">+ anadir habito</a>
</div>
